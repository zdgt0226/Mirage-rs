...
> - **当前无前向保密 (no forward secrecy)**: 会话密钥由**共享口令**派生, 不做 ECDH 密钥协商。
>   这意味着**一旦口令泄露, 用该口令加密过的历史与未来流量都可被解密**。请用高强度随机口令、
>   限制口令传播、定期更换。(前向保密改造在 roadmap 上, 见 brain external-audit-2026-08。)
